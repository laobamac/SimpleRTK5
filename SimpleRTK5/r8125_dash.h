...
int srtk5_dash_ioctl(struct net_device *dev, struct ifreq *ifr);
bool srtk5_check_dash_interrupt(struct srtk5_private *tp);
void srtk5_handle_dash_interrupt(struct net_device *dev);
void srtk5_clear_ipc2_isr(struct srtk5_private *tp);
void srtk5_set_ipc2_soc_imr_bit(struct srtk5_private *tp, u16 mask);
void srtk5_clear_ipc2_soc_imr_bit(struct srtk5_private *tp, u16 mask);
