...
IOReturn SimpleRTK5::identifyChip()
{
    ...
    default:
            ...
            IOLog("SimpleRTK5: Detect chip version %x \n", reg);
            break;
    }
    return result;
}

bool SimpleRTK5::initRTL8125()
{
    struct rtl8126_private *tp = &linuxData;
    UInt32 i;
...
*/
    ...
    if (is_valid_ether_addr((UInt8 *) macAddr)) {
        IOLog("SimpleRTK5: Get macAddr %s \n", macAddr);
...
void SimpleRTK5::disableRTL8125()
{
    struct rtl8126_private *tp = &linuxData;
...
void SimpleRTK5::restartRTL8125()
{
...
void SimpleRTK5::setupRTL8125()
{
    ...
    //Make sure that a packet fits into one buffer or therewill be trouble.
...
void SimpleRTK5::enablePCIOffset99()
{
    ...
    case CFG_METHOD_2:
    case CFG_METHOD_3:
            csiFun0WriteByte(0x99, tp->org_pci_offset_99);
            break;
    }
